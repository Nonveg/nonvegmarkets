...
<!--         <link rel="stylesheet" href="css/ionicons.min.css">
 -->
    ...
    <body id="body">
	    ...
	    <div class="navbar-default navbar-fixed-top" id="navigation">
	        <div class="container">
	            ...
	            <div class="navbar-header">
	                ...
	                <label class="navbar-brand" style="color:white;">
	                <!-- <img class="img-circle" id="img_logo2" src="images/scart.jpg"> -->
	                <i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;NON-VEG MARKET
	    ...
	    <div class=col-md-6>      
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:800px;height:300px;">
        <!-- Loading Screen -->
        <div data-u="loading" style="position:absolute;top:0px;left:0px;background-color:rgba(0,0,0,0.7);">
            <div style="filter: alpha(opacity=70); opacity: 0.7; position: absolute; display: block; top: 0px; left: 0px; width: 100%; height: 100%;"></div>
            <div style="position:absolute;display:block;background:url('images/loading.gif') no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
        </div>
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:800px;height:300px;">
            <div>
        ...
        <span data-u="arrowright" class="jssora13r" style="top:0px;right:30px;width:40px;height:50px;" data-autocenter="2"></span>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-md-6">
	                    <div class="block">
	                        <h1 class="wow fadeInDown">ORDER YOUR NON-VEG ITESM</h1>
	                        ...
	                        <div class="wow fadeInDown" data-wow-delay="0.3s">
	                        	<a class="btn btn-default btn-home" href="#about" role="button">BOOK ORDER</a>
	                        </div>
	                    </div>
	                </div>
                    ...
                    <form id="login-form">
		                <div class="modal-body">
				    		<div id="div-login-msg">
                                <div id="icon-login-msg" class="ion-chevron-right"></div>
...
<!--END MODAL LOGIN  -->
            ...
            <div class="container">
                <div class="row">
                    <div class="heading wow fadeInUp">
                        <h2>Our service</h2>
                        <p>We are Providing the Best Quality Of non-veg item's in Bhubaneswar Area..<br> Here you are going to get the Fully Fresh Item as Market Ex:-</p>
                    </div>
      ...
      <!--  <section id="call-to-action" class="section">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-5 wow fadeInUp">
						<div class="block text-left">
							<div class="sub-heading">
								...
								<p>We are Located at the Heart Of the Bhubaneswar City,We are pleased to Help You.</p>
							</div>
							<address class="address">
                                <hr>
								<p>Saheed Nagar,<br> Bhubaneswar,<br> Odisha</p>
                                <hr>
                                <p><strong>E-mail:</strong>&nbsp;nonvegmarkets@gmail.com<br>
                                <strong>Mobile:</strong>&nbsp;+91 9861787560,+91 9853585363,+91 9583702116</p>
        ...
        <footer>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="block">
                            <p>Copyright &copy; <a href="http://www.nonvegmarkets.com">NonvegMarkets</a>| All right reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script src="js/slider/jssor.slider-22.2.8.min.js" type="text/javascript"></script>
